...
<p>
            ...
            <p>It makes me think of how you act to me</p>
            <p class="gray">Это заставляет меня задуматься о том, как ты поступаешь со мной</p>
            <p>You do favors and then rapidly</p>
            <p class="gray">Делаешь оболжение, а затем резко</p>
            <p>You just turn around and start asking me about</p>
            <p class="gray">Отворачиваешься и начинаешь требовать</p>
            <p>Things you want back from me</p>
            <p class="gray">Расплаты</p>
            <h3>[Bridge:]</h3>
